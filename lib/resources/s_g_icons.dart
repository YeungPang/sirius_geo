...
Widget getIcon(Map<String, dynamic> map) {
  IconData id = myIcons[map["icon"]];
  if (id == null) {
    return null;
  }
  double size = map["iconSize"] ?? 24.0;
  Color color = map["iconColor"] ?? Colors.black;
  return Icon(id, size: size, color: color);
}
